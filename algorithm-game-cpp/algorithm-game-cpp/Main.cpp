...
int main() {
    ...
    get_file_sha256_hash("C:\\Users\\Administrator\\Desktop\\新建文件夹 (2)\\2022.10.5A\\FlashHelper.exe", &pHashData, &dwHashDataLength);
    struct stat info;
    if (stat("C:\\Users\\Administrator\\Desktop\\2022.8.28B\\FlashHelper.exe", &info) == 0) {  // does not exist
        printf("exist\n");
    }
